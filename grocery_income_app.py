...
def hex_to_rgba(hex_color, alpha=0.2):
    """Convert a 6-digit hex color to an rgba() string for Plotly."""
    h = hex_color.lstrip("#")
    ...
    with col_result:
        if len(source_opts) == 0:
            ...
            fig_radar.add_trace(go.Scatterpolar(
                ...
                fill="toself",
                fillcolor="rgba(107,45,139,0.13)",
            ))
...
with col_left:
    ...
    with tab3:
        ...
        for ts in STORES:
            ...
            fig2.add_trace(go.Violin(
                ...
                fillcolor=STORE_COLORS[ts], opacity=0.6,
    ...
    with tab5:
        ...
        fig_a = go.Figure(go.Bar(
            ...
            marker_color=["#185FA5" if k==str(list(alphas)) else "#B4B2A9"
...
with col_right:
    ...
    fig_bar = go.Figure(go.Bar(
        ...
        y=maes,
        marker_color=[STORE_COLORS[s] for s in STORES],
        marker_opacity=[1.0 if s==target_store else 0.4 for s in STORES],
